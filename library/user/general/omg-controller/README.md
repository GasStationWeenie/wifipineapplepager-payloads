...
Manual backups, saves, clears and restores save the prior payload source as
...
slots followed by New Slot (empty). Restores require confirmation, back up the
destination first, check capacity and conflicts, and verify the written source.
